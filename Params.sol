...
contract Params {
    ...
    uint256 public constant MinimalStakingCoin = 0.1 ether;
    // minimum initial staking to become a validator
    uint256 public constant minimumValidatorStaking = 3 ether;


    // percent distrubution of Gas Fee earned by validator 100000 = 100%
    uint public constant stakerPartPercent = 70000;          //70% 
